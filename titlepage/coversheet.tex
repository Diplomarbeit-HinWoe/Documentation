...
%
% student names are taken from global-const.tex
%
\def\nameone{\firstauthor}
\def\nametwo{\secondauthor}
%
...
%
% project partner is taken from global-const.tex (omitted if not defined there)
%
...
{\large\nameone}\par
{\large\nametwo}
\ifundefined{thirdauthor}\else
\par{\large\thirdauthor}
\fi
\ifundefined{fourthauthor}\else
\par{\large\fourthauthor}
\fi
\medskip\bigskip\par
\IfStrEq{\thesislang}{de}
{
...
\smallskip\par
{\large\firstreferee}
\ifundefined{projectpartner}\else
\medskip\bigskip\par
\IfStrEq{\thesislang}{de}
{
Projektpartner:
