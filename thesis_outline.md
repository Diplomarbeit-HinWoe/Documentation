...
### 1.1 Project context and motivation [W,H]
...
### 1.2 Initial situation and problem statement [W,H]
...
### 2.3 Provenance and collection-data standards [H]

#### 2.3.1 W3C PROV and general metadata models
...
#### 2.3.3 Operational and linked-data standards

- SPECTRUM and Europeana Data Model:
...
### 2.4 Collection management systems and object identification [W]

#### 2.4.1 Existing collection-management solutions
...
- Note: The final text should name only products that have been systematically investigated and should separate vendor documentation from peer-reviewed or official-standard evidence.

#### 2.4.2 Approaches to object identification
...
### 2.5 Approaches to 3D measurement [H]

#### 2.5.1 Traditional and image-based methods
...
#### 2.5.2 Depth-camera technologies and project hardware
...
- Existing camera classes and project constraints:
...
### 3.1 Solution overview and requirements [H,W]
...
- Recommended use cases:
  ...
  - Interact with the chatbot for natural-language queries.
  - Review and approve pending changes from chatbot-executed import scripts.

### 3.3 Decision methodology and data model [H]
...
### 3.4 Technical architecture decisions [H]

#### 3.4.1 Measurement and similarity approaches
...
#### 3.4.2 Storage and deployment architecture
...
### 3.5 End-to-end workflows [H]

#### 3.5.1 Object registration workflow
...
#### 3.5.2 Similarity search workflow
...
### 3.6 Security and integrity concept [H]
...
- [W]
  ...
  - Approval workflow for chatbot-generated changes (flagged records not visible until approved).
  - Read-only database access for queries vs. write access requiring confirmation.
- Integrity protection and its limitations.
- Precise use of terms such as *traceable*, *tamper-evident* and *tamper-resistant* instead of claiming absolute forgery protection.
---
...
### 4.1 System architecture and frontend [H,W]
...
#### 4.2.2 Object and provenance data model
...
- Pending-import entities: temporary storage for chatbot-generated changes awaiting approval.

#### 4.2.3 ArtPilot architecture
 Chatbot integration:
  - LLM service connection and prompt engineering.
  - Database query generation and validation.
  - Sandboxed script execution environment (e.g., isolated container or restricted runtime).
  - Approval workflow: flagged imports stored separately until user confirmation.
  - Security measures: query parameterization, resource limits, timeout handling.
- Request validation and error handling.

### 4.3 Data storage and search [H]

#### 4.3.1 Database and media management
...
#### 4.3.2 Full-text search and filtering
...
#### 4.4.2 Similarity computation and robustness
...
- Note: No claim should be made that image similarity alone proves object identity.

### 4.5 Depth camera and 3D measurement [H]

#### 4.5.1 Hardware, software and measurement principle
...
#### 4.5.2 Data quality and measurement uncertainty

- Preprocessing and data-quality handling:
...
#### 4.5.3 Measurement versus scanning and limitations

- Difference between measurement and 3D scanning:
...
- Limitations for historical objects:
...
### 4.6 Authentication, authorization and auditability [H]
...
### 4.7 Deployment and operations [H]
...
### 4.8 Testing concept and traceability [W]
...
### 5.1 Evaluation methodology and development process [W]
...
### 5.2 Provenance data model evaluation [H]
...
### 5.3 Depth-camera measurement evaluation [H]

#### 5.3.1 Experimental setup and metrics
...
### 5.4 Image similarity and duplicate detection evaluation [W]
...
#### 5.4.2 Threshold evaluation and practical usability
...
### 5.5 System functionality and usability evaluation [H,W]

- Search and application functionality:
  - Search correctness.
  ...
  - API response behaviour.
    - Chatbot query accuracy and relevance.
    - Sandboxed script execution reliability.
...
### 5.6 Performance and operational evaluation [H]
...
### 5.7 Lessons learned and future improvements [W,H]
...
### 5.8 Limitations and threats to validity [W]
